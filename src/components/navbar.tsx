...
import { motion, useScroll, useMotionValueEvent, AnimatePresence, useSpring, useMotionTemplate, useTransform } from "motion/react";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden md:flex gap-6 relative group" id="nav-links">
          <motion.div
