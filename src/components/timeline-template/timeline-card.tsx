  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1 }}
        className={cn(
          'relative grid place-items-center backdrop-blur-sm rounded-full',
          isOdd ? 'md:translate-x-1/2 -translate-x-1/2' : '-translate-x-1/2'
        )}
      >
        <Sparkles
          className='w-6 h-6 md:w-10 md:h-10 text-accent-primary'
          strokeWidth={1.5}
        />
      </motion.div>
      ...
      >
        <motion.div
          ...
          transition={transition}
          className={cn(
            'flex text-text-muted text-sm font-medium mb-2',
        ...
        <motion.p
          ...
          transition={transition}
          className={cn(
            'md:text-3xl w-full text-xl font-[Arial] text-green-600 font-bold font-stretch-extra-condensed text-wrap',
